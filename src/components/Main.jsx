...
export default function Main() {
    ...
    const partsList = [
        { id: 1, name: "Фільтр масляний", brand: "Bosch", price: 250, image: "/images/filter.jpg" },
        // ДОДАЛИ ПРАПОРЕЦЬ isPromo: true
            ...
            <div className="catalog-grid">
                {partsList.map((part) => (
                    <PartCard 
                        ...
                        // ОБОВ'ЯЗКОВО ПЕРЕДАЄМО isPromo В КАРТКУ
